<template>
  <el-dialog
    ...
    :title="`Terminal Leave Endorsement - ${employeeName}`"
    width="90%"
    :before-close="handleClose"
    class="tle-preview-modal"
  >
    <template #header>
      <div class="flex items-center justify-between">
        <h3 class="text-lg font-medium text-gray-900">
          Terminal Leave Endorsement - {{ employeeName }}
        </h3>
    ...
    <div class="preview-container">
      <div v-if="loading" class="loading-container">
        ...
        <p class="loading-text">Generating Terminal Leave Endorsement...</p>
      </div>
      
      <div v-else-if="error" class="error-container">
        <el-icon class="error-icon"><Warning /></el-icon>
        <p class="error-text">Failed to load Terminal Leave Endorsement preview</p>
      ...
      <div v-else class="no-content">
        ...
        <p>No Terminal Leave Endorsement to preview</p>
      </div>
    </div>
