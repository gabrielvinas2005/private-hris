    ...
    */
    ...
    'connections' => [
        ...
        'sqlsrv' => [
            ...
            // ODBC Driver 17 requires 'yes' or 'no' (not 'optional', true, false, etc.)
            'encrypt' => env('DB_ENCRYPT') === 'no' ? 'no' : 'yes',
            'trust_server_certificate' => env('DB_TRUST_SERVER_CERTIFICATE', 'true') === 'false' ? 'no' : 'yes',
        ],
        ...
        'attachments' => [
            ...
            'port' => env('ATTACHMENTS_DB_PORT', env('DB_PORT', '1435')),
            'database' => env('ATTACHMENTS_DATABASE', 'WTIHRIS_PTTC_ATTACHMENTS'),
