    ...
    public function store(Request $request, $id)
    {
        try {
            ...
            $data = array(
                ...
                // IMPORTANT:
                // In Vacant Position Posting, non_plantillas.status is treated as the approval flag:
                // 1 = approved, 0 = not approved.
                // So newly-created non-plantilla postings must start at 0 (for posting / approvable).
                'status' => ($id == 0 ? 0 : ($request->has('active') ? 1 : 0)),
