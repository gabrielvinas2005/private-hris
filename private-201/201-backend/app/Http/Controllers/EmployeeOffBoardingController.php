...
class EmployeeOffBoardingController extends Controller
{
        ...
        try {
            ...
            if ($id == 0) {
                $data_audit = array(
                    ...
                    'menu'    => 'Off-boarding',
                    'activity' => 'Add',
                    'description' => 'Added employee off-boarding informations.',
                );
                ...
                $data_audit = array(
                    ...
                    'menu'    => 'Off-boarding',
                    'activity' => 'Update',
                    'description' => 'Updated employee off-boarding informations.',
                );
    ...
    public function info($id, $employee_id)
    {
        try {
            ...
            // Off-boarding record (include remarks)
            $offboarding = DB::table('employee_offboardings as eo')
                ->join('offboarding_natures as n', 'n.id', '=', 'eo.nature_id')
                ->select(
                    'eo.id',
                    'eo.employee_id',
                    'eo.nature_id',
