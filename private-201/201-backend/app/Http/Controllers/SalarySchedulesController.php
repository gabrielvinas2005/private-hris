    ...
    public function store(Request $request)
    {
        try {
            ...
            $data_audit = array(
                ...
                'activity' => 'Add',
                'description' => 'Added ' . $request->name . ' salary schedule informations.',
            );
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $data_audit = array(
                ...
                'menu'    => 'Salary Schedule Setup',
                'activity' => 'Update',
                'description' => 'Updated ' . $request->name . ' salary schedule informations.',
            );
    ...
    public function destroy($id)
    {
        try {
            ...
            $data_audit = array(
                ...
                'menu'    => 'Salary Schedule Setup',
                'activity' => 'Delete',
                'description' => 'Deleted salary schedule informations.',
            );
