...
class EmployeeMedicalCertificateController extends Controller
{
    ...
    /**
     * Safely load JSON and return the `RECORDS` array. Tries several base paths.
     */
    protected function loadJsonRecords(string $filename, string $recordsKey = 'RECORDS') : array
    {
        ...
        // If not found, throw a clear exception to surface the missing path
    ...
    public function index()
    {
        ...
        $data = DB::table('employees')
            ...
            ->whereYear('employees.date_hired', $year)
            ->whereMonth('employees.date_hired', $month)
    ...
    public function print(Request $request)
    {
        ...
        // Load JSON data for regions, provinces, cities, and barangays (robust path resolution)
        ...
        $barangay_data = $this->loadJsonRecords('refbrgy.json');
        ...
        // Generate PDF
        $pdf = PDF::loadView('employee_medical_certificates.employee_medical_certificate_print_2025', compact(
            'employees'
