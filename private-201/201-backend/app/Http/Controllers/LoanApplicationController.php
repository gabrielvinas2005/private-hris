...
class LoanApplicationController extends Controller
{
    ...
    public function store(Request $request, $id)
    {
        ...
        if ($pending_deductions_absent->isEmpty()) {
            ...
            $pending_absent = $pending_deductions_absent[0]->pending_deduction;
        }
        ...
        if ($pending_deductions_late->isEmpty()) {
            ...
            $pending_late = $pending_deductions_late[0]->pending_deduction;
        }
        ...
        if ($pending_deductions_undertime->isEmpty()) {
            ...
            $pending_undertime = $pending_deductions_undertime[0]->pending_deduction;
        }
    ...
    public function getEmployeeTakeHomeOLD(Request $request)
    {
        ...
        try {
            ...
            // Tax Calculation - Monthly calculation
            // Formula: tax = percentage * (basic_salary - min_amount) + base_tax
            // Use basic salary directly, not taxable amount after deductions
            if ($tax_amount == 0) {
                try {
