        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Oath of Office</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
...
<section class="content">
    ...
    <div class="card card-info">
        <form action="{{ route('oath_of_office_print') }}" role="form" method="POST" target="_blank">
            @csrf
            <div>
...
<script>
    ...
    $(function() {
        $('#oath_of_office').addClass('active');
    });
</script>
@endsection