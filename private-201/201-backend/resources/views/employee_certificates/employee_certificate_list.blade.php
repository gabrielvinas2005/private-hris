        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Employee Certificate</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
...
<section class="content">
    ...
    <div class="card card-info">
        ...
        <form action="{{ route('employee_certificates_print') }}" role="form" method="POST" target="_blank">
            @csrf
            <div>
...
<script>
    ...
    $(function() {
        $('#employee_certificates').addClass('active');
    });
</script>
<script>
