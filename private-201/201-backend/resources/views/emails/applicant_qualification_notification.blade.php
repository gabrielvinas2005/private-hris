    ...
    <body>
        ...
        <div>
            ...
            @if ($applicants[0]->exam_time_from == $applicants[0]->exam_time_to)
                <p>Time: <b>{{ date('h:s A', strtotime($applicants[0]->exam_time_from)) }}</b></p>
            @else
                <p>Time:
                    <b>{{ date('h:s A', strtotime($applicants[0]->exam_time_from)) .
                        ' to ' .
                        date('h:s A', strtotime($applicants[0]->exam_time_to)) }}</b>
                </p>
            @endif
