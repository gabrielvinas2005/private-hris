...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>No Pending Certificate</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}" onclick="removeCokie();">Home</a></li>
                        <li class="breadcrumb-item active">No Pending Certificate</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    ...
    <section class="content">
        ...
        <div class="card card-info">
            ...
            <form action="{{ route('no_pending_certificates_print') }}" role="form" method="POST" target="_blank">
                @csrf
                <div>
...
@section('scripts')
    <script>
        ...
        $(function() {
            $('#no_pending_certificates').addClass('active');
        });
    </script>
    <script>
