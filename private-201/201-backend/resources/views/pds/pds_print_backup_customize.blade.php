            ...
            <div class="main" style="width: 100%;">
                <div>
                    <table style="width: 100%;padding:10px;">
                        <tr>
                            <td colspan="9" style="border-bottom: none;font-size: 12px;font-weight: bold;">CS Form
                                No. 212</td>
                        </tr>
                        <tr>
                            <td colspan="9"
                                style="border-bottom: none;border-top: none;font-style: italic;font-size: 10px;">Revised
                                2017</td>
                        </tr>
                        <tr>
                            <td colspan="9"
                                style="border-bottom: none;border-top: none;padding: 8px;font-size: 22px;font-family: 'Arial Black';font-weight: bolder;">
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="text-align: start;"><label style="word-wrap:break-word;"><input
                                            ...
                                            {{ $info->is_dual_citizent == false ? 'checked' : '' }}>
                                        Filipino</label>
                                </div>
                            </td>
                            <td colspan="2"><label><input type="checkbox"
                                        {{ $info->is_dual_citizent == true ? 'checked' : '' }}>
                                    Dual
                        ...
                        <tr>
                            ...
                            <td><label><input type="checkbox" {{ $info->by_birth == true ? 'checked' : '' }}> by
                                    Birth</label></td>
                            <td colspan="2"><label><input type="checkbox"
                                        {{ $info->by_naturalization == true ? 'checked' : '' }}>
                                    by
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="border-bottom: none;padding: 5px;">
                                ...
                                <label for=""><input type="checkbox"
                                        {{ $info->civil_status == 'Married' ? 'checked' : '' }}>
                                    Married</label>
                            </td>
                            <td colspan="2"
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="border-bottom: none;border-top: none;padding: 5px;">
                                <label for=""><input type="checkbox"
                                        {{ $info->civil_status == 'Widowed' ? 'checked' : '' }}>
                                    Widowed</label>
                                <label for=""><input type="checkbox"
                                        {{ $info->civil_status == 'Separated' ? 'checked' : '' }}>
                                    Separated</label>
                            </td>
                            <td colspan="2"
                                style="background-color: lightgray;color: black;border-bottom: none;border-top: none;padding: 5px;">
                        ...
                        <tr>
                            <td style="background-color: lightgray;color: black;border-bottom: none;padding: 5px;">12.
                                PHILHEALTH NO.</td>
                            <td colspan="2" style="border-bottom: none; none;padding: 5px;">{{ $info->philhealth_no }}</td>
                            <td colspan="2"
                                style="background-color: lightgray;color: black;border-bottom: none;border-top: none;padding: 5px;">
                                <center>ZIP CODE</center>
                            </td>
                        ...
                        <tr>
                            <td style="background-color: lightgray;color: black;border-bottom: none;padding: 5px;">22.
                                SPOUSE'S SURNAME</td>
                            <td colspan="4">{{ strtoupper($info->spouse_last_name) }}</td>
                        ...
                        <tr>
                            <td style="background-color: lightgray;color: black;border-bottom: none;border-top: none;">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; FIRST NAME</td>
                            <td colspan="3">{{ strtoupper($info->spouse_first_name) }}</td>
                            <td style="background-color: lightgray;color: black;padding-bottom: 10px;">NAME EXTENSION
                                (JR., SR) {{ strtoupper($info->spouse_suffix) }}</td>
                            <td colspan="3">
                                <center>
                                    {{ isset($children[0]->row) && $children[0]->row == 1 ? $children[0]->child_name . ' ' . $children[0]->child_lastname : '' }}
                                </center>
                            </td>
                            <td>
                                <center>
                                    {{ isset($children[0]->row) && $children[0]->row == 1
                                        ? date('m/d/Y', strtotime($children[0]->child_birthdate))
                                        : '' }}
                                </center>
                            </td>
                        </tr>
                        <tr>
                            <td
                                style="background-color: lightgray;color: black;border-bottom: none;border-top: none;padding-bottom: 10px;">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; MIDDLE NAME</td>
                            <td colspan="4">{{ strtoupper($info->spouse_middle_name) }}</td>
                            <td colspan="3">
                                <center>
                            ...
                            <td>
                                <center>
                                    {{ isset($children[1]->row) && $children[1]->row == 2
                                        ? date('m/d/Y', strtotime($children[1]->child_birthdate))
                                        : '' }}
                                </center>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <center>
                                    {{ isset($children[2]->row) && $children[2]->row == 3
                                        ? date('m/d/Y', strtotime($children[2]->child_birthdate))
                                        : '' }}
                                </center>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <center>
                                    {{ isset($children[3]->row) && $children[3]->row == 4
                                        ? date('m/d/Y', strtotime($children[3]->child_birthdate))
                                        : '' }}
                                </center>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <center>
                                    {{ isset($children[4]->row) && $children[4]->row == 5
                                        ? date('m/d/Y', strtotime($children[4]->child_birthdate))
                                        : '' }}
                                </center>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <center>
                                    {{ isset($children[5]->row) && $children[5]->row == 6
                                        ? date('m/d/Y', strtotime($children[5]->child_birthdate))
                                        : '' }}
                                </center>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="background-color: lightgray;color: black;border-bottom: none;padding: 5px;">24.
                                FATHER'S SURNAME</td>
                            <td colspan="4">{{ strtoupper($info->father_last_name) }}</td>
                            <td colspan="3">
                                <center>
                            ...
                            <td>
                                <center>
                                    {{ isset($children[6]->row) && $children[6]->row == 7
                                        ? date('m/d/Y', strtotime($children[6]->child_birthdate))
                                        : '' }}
                                </center>
                            </td>
                        </tr>
                        <tr>
                            <td style="background-color: lightgray;color: black;border-bottom: none;border-top: none;">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; FIRST NAME</td>
                            <td colspan="3">{{ strtoupper($info->father_first_name) }}</td>
                            <td style="background-color: lightgray;color: black;padding-bottom: 10px;">NAME EXTENSION
                                (JR., SR) {{ strtoupper($info->father_suffix) }}</td>
                            <td colspan="3">
                                <center>
                            ...
                            <td>
                                <center>
                                    {{ isset($children[7]->row) && $children[7]->row == 8
                                        ? date('m/d/Y', strtotime($children[7]->child_birthdate))
                                        : '' }}
                                </center>
                            </td>
                        </tr>
                        <tr>
                            <td
                                style="background-color: lightgray;color: black;border-bottom: none;border-top: none;padding-bottom: 10px;">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; MIDDLE NAME</td>
                            <td colspan="4">{{ strtoupper($info->father_middle_name) }}</td>
                            <td colspan="3">
                                <center>
                            ...
                            <td>
                                <center>
                                    {{ isset($children[8]->row) && $children[8]->row == 9
                                        ? date('m/d/Y', strtotime($children[8]->child_birthdate))
                                        : '' }}
                                </center>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <center>
                                    {{ isset($children[9]->row) && $children[9]->row == 10
                                        ? date('m/d/Y', strtotime($children[9]->child_birthdate))
                                        : '' }}
                                </center>
                            </td>
                        </tr>
                        <tr>
                            <td
                                style="background-color: lightgray;color: black;border-bottom: none;border-top: none;padding: 5px;">
                                &nbsp;&nbsp;&nbsp; SURNAME</td>
                            <td colspan="4">{{ strtoupper($info->mother_last_name) }}</td>
                            <td colspan="3">
                                <center>
                            ...
                            <td>
                                <center>
                                    {{ isset($children[10]->row) && $children[10]->row == 11
                                        ? date('m/d/Y', strtotime($children[10]->child_birthdate))
                                        : '' }}
                                </center>
                            </td>
                        </tr>
                        <tr>
                            <td
                                style="background-color: lightgray;color: black;border-bottom: none;border-top: none;padding-bottom: 10px;">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; FIRST NAME</td>
                            <td colspan="4">{{ strtoupper($info->mother_first_name) }}</td>
                            <td colspan="3">
                                <center>
                            ...
                            <td>
                                <center>
                                    {{ isset($children[11]->row) && $children[11]->row == 12
                                        ? date('m/d/Y', strtotime($children[11]->child_birthdate))
                                        : '' }}
                                </center>
                            </td>
                        </tr>
                        <tr>
                            <td
                                style="background-color: lightgray;color: black;border-bottom: none;border-top: none;padding-bottom: 10px;">
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; MIDDLE NAME</td>
                            <td colspan="4">{{ strtoupper($info->mother_middle_name) }}</td>
                ...
                <div>
                    <table style="width: 100%;padding:10px;">
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="background-color: lightgray;color: black;">
                                <center>DEPARTMENT / AGENCY / OFFICE / COMPANY <br> (Write in full/Do not
                                    abbreviate)
                                </center>
                            </td>
                            <td style="background-color: lightgray;color: black;">
                            ...
                            <td style="background-color: lightgray;color: black;">
                                <center>SALARY/ JOB/ PAY GRADE (if applicable)& STEP (Format "00-0")/ INCREMENT
                                </center>
                            </td>
                            <td style="background-color: lightgray;color: black;">
                    ...
                    <table style="width: 100%;padding:10px;">
                        ...
                        <tr>
                            ...
                            <td colspan="5" style="background-color: lightgray;color: black;">
                                <center>32. NON-ACADEMIC DISTINCTIONS / RECOGNITION <br> (Write in full)
                                </center>
                            </td>
                            <td colspan="2" style="background-color: lightgray;color: black;">
                ...
                <div>
                    <table style="width: 100%;padding:10px;">
                        ...
                        <tr>
                            ...
                            <td colspan="6">
                                @foreach ($quesionaires as $q)
                                    @if ($q->code == '34.a')
                                        <div>
                                            <label for=""><input type="checkbox"
                                                    {{ $q->is_yes == true ? 'checked' : '' }}>
                                                Yes</label>
                                            <label for=""><input type="checkbox"
                                                    {{ $q->is_no == true ? 'checked' : '' }}>
                                                No</label>
                                        </div>
                                    @endif
                                    @if ($q->code == '34.b')
                        ...
                        <tr>
                            <td colspan="3" style="background-color: lightgray;color: black;border-bottom: none;">
                                <p style="font-size: 10px;">35. a. Have you ever been found guilty of any
                                    administrative
                                    offense?</p>
                            </td>
                        ...
                        <tr>
                            <td colspan="3" style="background-color: lightgray;color: black;border-top: none;">
                                <p style="font-size: 10px;"> b. Have you been criminally charged before any court?</p>
                            </td>
                        ...
                        <tr>
                            <td colspan="3" style="background-color: lightgray;color: black;">
                                <p style="font-size: 10px;">36. Have you ever been convicted of any crime or violation
                                    of
                        ...
                        <tr>
                            <td colspan="3" style="background-color: lightgray;color: black;">
                                <p style="font-size: 10px;">39. Have you acquired the status of an immigrant or
                                    permanent
                        ...
                        <tr>
                            <td colspan="3"
                                ...
                                <p style="font-size: 10px;">b. Are you a person with disability?</p>
                            </td>
                        ...
                        <tr>
                            <td colspan="3" style="background-color: lightgray;color: black;border-top: none;">
                                <p style="font-size: 10px;">c. Are you a solo parent?</p>
                            </td>
                            <td colspan="6" style="border-top: none;">
                                @foreach ($quesionaires as $q)
                                    @if ($q->code == '40.c')
                        ...
                        <tr>
                            <td colspan="3" style="background-color: lightgray;color: black;">
                                <p style="font-size: 10px;">41. REFERENCES <label style="color: red;">(Person not
                                        related
                                        by consanguinity or affinity to applicant /appointee)</label></p>
                            </td>
                            <td colspan="6" rowspan="6" style="border-bottom: none;">
                                <div
                        ...
                        {{-- <tr>
                            <td colspan="3" style="background-color: lightgray;color: black;">
                                <p style="font-size: 10px;">
                                    ...
                                    regulations of the Republic of the Philippines. I authorize the agency
                                    head/authorized representative to
                                    verify/validate the contents stated herein. I agree that any misrepresentation made
                                    in this document and its
                            ...
                            <td colspan="3" style="padding:5px; border-right:none;">
                                <div style="width: 200px; height: 80px;margin: auto;">
                                    <table style="height: 100%;">
                                        <tr>
                                            <td style="background-color: lightgray;color: black;">Government Issued
                                                ID
                                                (i.e.Passport, GSIS, SSS, PRC, Driver's License, etc.) PLEASE
                                                INDICATE
