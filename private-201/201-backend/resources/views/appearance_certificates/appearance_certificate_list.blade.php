        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Certificate of Appearance</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
...
<section class="content">
    ...
    <div class="card card-info">
        ...
        <form action="{{ route('appearance_certificates_print') }}" role="form" method="POST" target="_blank">
            @csrf
            <div>
        ...
        <div class="card-footer">
            <h6>Certificate of Appearance</h6>
        </div>
    </div>
    <!-- /.card -->
...
<script>
    ...
    $(function() {
        $('#appearance_certificates').addClass('active');
    });
</script>
<script>
