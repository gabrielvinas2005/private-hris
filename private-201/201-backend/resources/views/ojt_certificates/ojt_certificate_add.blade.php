...
<section class="content">
    ...
    <div class="card card-info">
        <div class="card-header">
            <h3 class="card-title">Add OJT Information</h3>
        </div>
        <div class="card-body">
            <form action="/ojt_certificates_add" role="form" method="post">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <button type="submit" class="btn btn-primary">Save OJT Information</button>
                </div>
            </div>
