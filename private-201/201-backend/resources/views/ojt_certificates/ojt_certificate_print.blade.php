            ...
            <div style="text-align: center;padding-top: 15px; padding-bottom: 30px;">
                ...
                <div>
                    ...
                    <p
                        ...
                        This is to certify that <u>{{ $employee->name }}</u> has satisfactorily completed
                        <u>{{ $employee->hours }}</u> hours of On-the-Job training from
                        <u>{{ date('F d, Y', strtotime($employee->date_start)) }}</u> to
                        <u>{{ date('F d, Y', strtotime($employee->date_end)) }}</u>.
                    </p>
                </div>
                <br>
                <div>
                    <p style="text-indent: 0.5in;text-align: justify;">Issued upon the request of
                        <u>{{ $employee->name }}</u> for
                        whatever legal purpose it may serve him/her.
                    </p>
                </div>
                <br>
                <div>
                ...
                <div style="padding-top: 1in;float: right;">
                    <p style="text-align: center; padding:0;">{{ $employee->signatory_name }}</p>
                    <p style="text-align: center; padding:0;">{{ $employee->signatory_position }}</p>
                </div>
            </div>
        </div>
