...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Terminal Leave Endorsement</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}" onclick="removeCokie();">Home</a></li>
                    <li class="breadcrumb-item active">Terminal Leave Endorsement</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
...
<section class="content">
    ...
    <div class="card card-info">
        ...
        <form action="{{ route('terminal_leave_endorsement_print') }}" role="form" method="POST" target="_blank">
            @csrf
            <div>
        ...
        <div class="card-footer">
            <h6>Terminal Leave Endorsement</h6>
        </div>
    </div>
    <!-- /.card -->
...
<script>
    ...
    $(function() {
        $('#terminal_leave_endorsements').addClass('active');
    });
</script>
<script>
