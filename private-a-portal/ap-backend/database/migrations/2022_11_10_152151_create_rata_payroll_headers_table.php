...
class CreateRataPayrollHeadersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rata_payroll_headers', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('rata_payroll_headers');
    }
}
