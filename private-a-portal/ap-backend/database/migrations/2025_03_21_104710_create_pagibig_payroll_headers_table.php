...
class CreatePagibigPayrollHeadersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('pagibig_payroll_headers', function (Blueprint $table) {
        ...
        DB::unprepared("
            ...
            DECLARE @PK_NAME_TO_ADD AS VARCHAR(200) = 'PK_pagibig_payroll_headers'
            DECLARE @TABLE_NAME AS VARCHAR(200) = 'pagibig_payroll_headers'
            ...
            SET @OLD_INDEX = (
                                ...
                                and t.name = 'pagibig_payroll_headers'
                                )
            ...
            SET @SQL_DROP = 'ALTER TABLE pagibig_payroll_headers DROP CONSTRAINT IF EXISTS ' + @OLD_INDEX
            EXEC(@SQL_DROP)
            SET @SQL_DROP = ''

            SET @SQL_CREATE = 'ALTER TABLE pagibig_payroll_headers ADD CONSTRAINT DF_pagibig_payroll_headers_amount DEFAULT 0 FOR amount'
            EXEC(@SQL_CREATE)
            SET @SQL_CREATE = ''
        ");
    }
    ...
    {
        Schema::dropIfExists('pagibig_payroll_headers');
    }
}
