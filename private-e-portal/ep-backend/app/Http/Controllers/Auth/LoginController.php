    ...
    */
    ...
    protected function authenticated()
    {
        ...
        if (Auth::check()) {
            ...
            if ((int) (Auth::user()->is_applicant ?? 0) === 1) {
                Auth::logout();
                return redirect()->route('login')->with('error', 'Applicant accounts cannot log in to this portal.');
            }
            ...
            if ((int) (Auth::user()->is_admin ?? 0) !== 1) {
                ...
                if (!$employee || (int) ($employee->is_employee ?? 0) !== 1) {
                    Auth::logout();
                    return redirect()->route('login')->with('error', 'Your Account is not an employee. Please contact system administrator.');
                }
            }
            ...
            if (Auth::user()->locked == 1) {
                ...
                //COMMENTED OUT: OTP and email verification for first-time employee login
                ...
                // // Skip OTP verification - go straight to home/dashboard
