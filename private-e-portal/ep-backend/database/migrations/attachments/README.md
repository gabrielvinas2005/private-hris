...
- `2026_03_02_143152_create_applicant_attachments_blob_table.php` - Creates the applicant_attachments table for storing resume files
- `2026_06_11_084236_create_non_dtr_attachments_table.php` - Creates the non_dtr_attachments table for COS accomplishment report files (BLOB storage)
