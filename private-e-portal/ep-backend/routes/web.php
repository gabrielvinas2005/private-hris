...
Route::get('/', 'VacanciesController@index')->name('vacancies');
Route::get('/position_info/{id}/{type_id}', 'VacanciesController@positions')->name('position_info');
Route::get('/applicant_add/{id}/{plantilla_id}', 'ApplicantsController@add')->name('applicant_add');
Route::post('/applicant_add/{id}/{plantilla_id}', 'ApplicantsController@store')->name('applicant_store');
Route::get('/applicant_registration', 'ApplicantsController@register')->name('applicant_registration');
Route::post('/applicant_registration_add', 'ApplicantsController@register_store')->name('applicant_registration_add');
