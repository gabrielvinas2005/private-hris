    ...
    @foreach ($leave as $dtl)
        <div class="main">
            ...
            <div class="header">
                ...
                <div class="subtitle">{{ $orgCompanyName }}</div>
                <div class="subtitle">{{ $orgCompanyAddress }}</div>
                <div class="subtitle">{{ $orgCompanyAddress }}</div>
            ...
            <table
                ...
                <tr>
                    ...
                    <td style="padding-bottom: 10px;">
                        <p style="font-size: 10px;display: inline-block;">5. SALARY</p>
                        <p
                            style="font-size: 10px;border-bottom: solid 1px black;text-align: center;display: inline-block;width: 100px;">
                            {{ number_format($dtl->salary, 2, '.', ',') }}
                        </p>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <td style="padding: 5px;width: 100px;">
                        <div style="vertical-align: middle;">
                            <div
                                ...
                                <p style="font-size: 5;margin: 0px;">
                                    {{ $dtl->leave_type_id == 2 || $dtl->leave_type_id == 16 ? 'X' : '' }}
                                </p>
                            </div>
                        ...
                        <div style="vertical-align: middle;">
                            <div
                                style="margin: 2px;border: solid 1px black;width: 10px;height: 10px;display: inline-block;text-align: center;">
                                <p style="font-size: 5;margin: 0px;">{{ $dtl->leave_type_id == 0 ? 'X' : '' }}</p>
                            </div>
                        ...
                        <div style="vertical-align: middle;">
                            <div
                                style="margin: 2px;border: solid 1px black;width: 10px;height: 10px;display: inline-block;text-align: center;">
                                <p style="font-size: 5;margin: 0px;">{{ $dtl->leave_type_id == 3 ? 'X' : '' }}</p>
                            </div>
                        ...
                        <div style="vertical-align: middle;">
                            <div
                                style="margin: 2px;border: solid 1px black;width: 10px;height: 10px;display: inline-block;text-align: center;">
                                <p style="font-size: 5;margin: 0px;">{{ $dtl->leave_type_id == 7 ? 'X' : '' }}</p>
                            </div>
                        ...
                        <div style="vertical-align: middle;">
                            <div
                                style="margin: 2px;border: solid 1px black;width: 10px;height: 10px;display: inline-block;text-align: center;">
                                <p style="font-size: 5;margin: 0px;">{{ $dtl->leave_type_id == 8 ? 'X' : '' }}</p>
                            </div>
                        ...
                        <div style="vertical-align: middle;">
                            <div
                                style="margin: 2px;border: solid 1px black;width: 10px;height: 10px;display: inline-block;text-align: center;">
                                <p style="font-size: 5;margin: 0px;">{{ $dtl->leave_type_id == 6 ? 'X' : '' }}</p>
                            </div>
                        ...
                        <div style="vertical-align: middle;">
                            <div
                                style="margin: 2px;border: solid 1px black;width: 10px;height: 10px;display: inline-block;text-align: center;">
                                <p style="font-size: 5;margin: 0px;">{{ $dtl->leave_type_id == 11 ? 'X' : '' }}</p>
                            </div>
                        ...
                        <p style="border-bottom: solid 1px black;margin-top: 20px;margin-bottom: 5px; width: 200px;">
                        </p>
                    </td>
                    <td style="padding: 5px;width: 100px;border-left: solid 1px black;">
                        ...
                        <div style="vertical-align: middle;">
                            ...
                            <p style="font-size: 6;display: inline-block;border-bottom: solid 1px black;width: 150px;">
                        ...
                        <div style="vertical-align: middle;">
                            ...
                            <p style="font-size: 6;display: inline-block;border-bottom: solid 1px black;width: 100px;">
                ...
                <tr>
                    <td style="padding: 5px;width: 100px;border-top: solid 1px black;">
                        ...
                        <div>
                            ...
                            --}}
                                {{ $data_with_pay[0]->total_applied_days ?? '' }}
                            </p>
                        </div>
                        ...
                        <div>
                            <p
                                ...
                                {{ $dtl->date_from == $dtl->date_to ? date('m-d-Y', strtotime($dtl->date_from)) : date('m-d-Y', strtotime($dtl->date_from)) . ' - ' . date('m-d-Y', strtotime($dtl->date_to)) }}
                            </p>
                        </div>
                    </td>
                ...
                <tr>
                        ...
                        <div>
                            <table
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="border: solid 1px black;border-collapse: collapse;font-size: 6;text-align: center;">
                                        @if ($leave_credeits_vl[0]->credits < 0)
                                            {{ number_format(0, 3, '.', ',') }}
                                        @else
                                            {{ number_format($leave_credeits_vl[0]->credits, 3, '.', ',') }}
                                        @endif
                                    </td>
                                    <td
                                        style="border: solid 1px black;border-collapse: collapse;font-size: 6;text-align: center;">
                                        @if (!isset($leave_credeits_sl))
                                            {{ number_format(0, 3, '.', ',') }}
                                        @else
                                            {{ number_format($leave_credeits_sl[0]->credits, 3, '.', ',') }}
                                        @endif
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td
                                        style="border: solid 1px black;border-collapse: collapse;font-size: 6;text-align: center;">
                                        @if ($leave[0]->leave_type_id == 16)
                                            {{ number_format($data_with_pay[0]->with_pay, 3, '.', ',') }}
                                        @else
                                            {{ number_format(0, 3, '.', ',') }}
                                        @endif
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="border: solid 1px black;border-collapse: collapse;font-size: 6;text-align: center;">
                                        @if ($leave[0]->leave_type_id == 16)
                                            @if ($leave_credeits_vl[0]->credits - $data_with_pay[0]->with_pay > 0)
                                                {{ $leave_credeits_vl[0]->credits - $data_with_pay[0]->with_pay }}
                                            @else
                                                {{ number_format(0, 3, '.', ',') }}
                                            @endif
                                        @else
                                    ...
                                    <td
                                        ...
                                        @if ($leave[0]->leave_type_id == 3)
                                            @if (!isset($leave_credeits_sl))
                                                {{ number_format(0, 3, '.', ',') }}
                                            @else
                                                @if ($leave_credeits_sl[0]->credits - $data_with_pay[0]->with_pay > 0)
                                                    {{ $leave_credeits_sl[0]->credits - $data_with_pay[0]->with_pay }}
                                                @else
                                                    {{ number_format(0, 3, '.', ',') }}
                                                @endif
                                            @endif
                    ...
                    <td style="padding: 5px;width: 100px;border-left: solid 1px black;border-top: solid 1px black;">
                        ...
                        <div style="vertical-align: middle;">
                            <div
                                style="margin: 2px;border: solid 1px black;width: 10px;height: 10px;display: inline-block;text-align: center;">
                                <p style="font-size: 5;margin: 0px;"></p>
                            </div>
                            <p style="font-size: 6;display: inline-block;">For Approval</p>
                            <p style="font-size: 6;display: inline-block;border-bottom: solid 1px black;width: 150px;">
                                {{ $leave[0]->approved_remarks }}
                            </p>
                        </div>
                        <div style="vertical-align: middle;">
                            <div
            ...
            <table
                ...
                <tr>
                    ...
                    <td
                        ...
                        <div>
                            <p style="font-size: 6;margin-bottom: 0px;margin-top: 5px;text-align: center;">
                                {{ $leave[0]->disapproved_remarks }}
                            </p>
                            <p style="font-size: 6;text-align: center;border-top: solid 1px black;margin-top: 10px;">
                            </p>
