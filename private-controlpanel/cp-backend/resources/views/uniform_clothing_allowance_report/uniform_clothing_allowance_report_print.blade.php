...
<head>
    ...
    <title>Uniform Clothing Allowance Report</title>
    <style>
...
<body>
    <div class="header">
        <div class="title">Uniform Clothing Allowance Report</div>
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: right;">₱{{ number_format($row->cloth_rate ?? 0, 2) }}</td>
                <td style="text-align: right;">{{ $row->actual_days ?? 0 }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
