    ...
    public function store(Request $request)
    {
        try {
            ...
            $dept_data = [
                ...
                'is_academic' => $request->input('is_academic', false) === true || $request->input('is_academic') === 'true' || $request->input('is_academic') === '1',
                'employee_id' => !empty($request->employee_id) ? (int) $request->employee_id : null,
