...
class CompetenciesController extends Controller
{
    ...
    public function delete($type_id, $id)
    {
        try {
            if ($type_id == 1) {
                ...
                // delete main competency data
                $data = DB::table('competencies')
                    ->select('id', 'name', DB::raw('2 as type_id'))
                    ->where('id', $id)->first();
    ...
    public function destroy($type_id, $id)
    {
        try {
            if ($type_id == 1) {
                // delete child data (subcompetency)
                ...
                $data_audit = array(
                    ...
                    'menu'    => 'Competencies Setup',
                    'activity' => 'Delete',
                    'description' => 'Deleted Sub Competencies table information',
                );
                ...
                // First delete all subcompetencies for this competency
                DB::table('subcompetencies')->where('competency_id', $id)->delete();

                // Then delete the main competency
                ...
                $data_audit = array(
                    ...
                    'menu'    => 'Competencies Setup',
                    'activity' => 'Delete',
                    'description' => 'Deleted ' . $competency->name . ' and its subcompetencies.',
                );
