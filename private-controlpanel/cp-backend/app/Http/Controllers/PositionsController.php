    ...
    public function store(Request $request)
    {
        try {
            ...
            $form_data = array(
                'code' => $request->code,
                'name' => $request->name,
                'is_administrative_position' => $request->input('is_administrative_position', false) === true || $request->input('is_administrative_position') === 'true' || $request->input('is_administrative_position') === '1',
