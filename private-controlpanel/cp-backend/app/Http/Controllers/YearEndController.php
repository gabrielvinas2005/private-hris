        ...
        try {
            ...
            for ($i = 0; $i < $arr_len; $i++) {
                if ($data['months'][$i] != NULL && $data['percentage'][$i] != NULL) {
                    ...
                    $cash_gift = isset($data['cash_gift'][$i]) ? $data['cash_gift'][$i] : 5000;

                    $rules = [
                        'months.' . $i => 'numeric|min:0',
                        'percentage.' . $i => 'numeric|min:0',
                        'cash_gift.' . $i => 'numeric|min:0',
                    ];
                    $messages = [
                        ...
                        'cash_gift.' . $i . '.numeric' => 'The cash gift field must be a number.',
                        'cash_gift.' . $i . '.min' => 'The cash gift field must be at least :min.',
                    ];
            ...
            $data_audit = array(
                ...
                'activity' => 'Update',
                'description' => 'Updated yearend table information',
            );
    ...
    public function destroy($id)
    {
        try {
            ...
            $data_audit = array(
                ...
                'menu'    => 'Year End Table Setup',
                'activity' => 'Delete',
                'description' => 'Deleted Year End table information',
            );
            Audit::create($data_audit);
        ...
        try {
            return $this->successResponse([
                'fields' => [
                    ...
                    'cash_gift' => ['type' => 'number', 'required' => false],
                ]
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $yearend_data = [
                ...
                'cash_gift' => $request->cash_gift ?? 5000,
            ];
            ...
            $data_audit = array(
                ...
                'menu'    => 'Year End Table Setup',
                'activity' => 'Update',
                'description' => 'Updated Year End table: ' . $request->months . ' months, ' . $request->percentage . '%, cash gift ' . ($request->cash_gift ?? 5000),
            );
            Audit::create($data_audit);
