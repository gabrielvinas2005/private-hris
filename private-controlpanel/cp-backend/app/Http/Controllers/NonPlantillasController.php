    ...
    public function store(Request $request, $id)
    {
        try {
            ...
            $data = array(
                ...
                'status' =>  $request->input('active', false) === true || $request->input('active') === 'true' || $request->input('active') === '1',
            ...
            if ($id == 0) {
                $data_audit = array(
                    ...
                    'activity' => 'Add',
                    'description' => 'Added non-plantilla information',
                );
                ...
                $data_audit = array(
                    ...
                    'menu'    => 'Non-Plantilla Setup',
                    'activity' => 'Update',
                    'description' => 'Updated non-plantilla information',
                );
    ...
    public function destroy($id)
    {
        try {
            ...
            $data_audit = array(
                ...
                'menu'    => 'Non-Plantilla Setup',
                'activity' => 'Delete',
                'description' => 'Deleted non-plantilla information',
            );
