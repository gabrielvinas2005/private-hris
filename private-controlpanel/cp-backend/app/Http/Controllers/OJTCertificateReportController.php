    ...
    public function index()
    {
        try {
            $data  = DB::table('ojt_informations')
                ->select('ojt_informationid', 'ojt_informationname', 'ojt_informationdate_start', 'ojt_informationdate_end', 'ojt_informationhours', 'ojt_informationsignatory_name', 'ojt_informationsignatory_position')
                ->orderBy('ojt_informationname', 'asc')
                ->get();
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $data_audit = array(
                ...
                'menu'    => 'OJT Certificate',
                'activity' => 'Update',
                'description' => 'Updated ' . $request->name . ' on OJT information',
            );
