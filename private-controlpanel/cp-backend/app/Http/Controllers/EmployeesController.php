        ...
        try {
            ...
            if ($id == 0) {
                ...
                $data_audit = array(
                    ...
                    'activity' => 'Add',
                    'description' => 'Added employee information',
                );
        ...
        try {
            if ($type_id == 1) {
                ...
                $data_audit = array(
                    ...
                    'activity' => 'Delete',
                    'description' => 'Deleted Child table information',
                );
            } elseif ($type_id == 2) {
                // delete child data
                ...
                $data_audit = array(
                    ...
                    'menu'    => 'Employee Record',
                    'activity' => 'Delete',
                    'description' => 'Deleted Education table information',
                );
            } elseif ($type_id == 3) {
                // delete child data
                ...
                $data_audit = array(
                    ...
                    'menu'    => 'Employee Record',
                    'activity' => 'Delete',
                    'description' => 'Deleted Service Record table information',
                );
            } elseif ($type_id == 4) {
                // delete child data
                ...
                $data_audit = array(
                    ...
                    'menu'    => 'Employee Record',
                    'activity' => 'Delete',
                    'description' => 'Deleted Employment Record table information',
                );
            } elseif ($type_id == 5) {
                // delete child data
                ...
                $data_audit = array(
                    ...
                    'menu'    => 'Employee Record',
                    'activity' => 'Delete',
                    'description' => 'Deleted Organization table information',
                );
            } elseif ($type_id == 8) {
                // delete child data
                ...
                $data_audit = array(
                    ...
                    'menu'    => 'Employee Record',
                    'activity' => 'Delete',
                    'description' => 'Deleted Recognition table information',
                );
            } elseif ($type_id == 9) {
                // delete child data
                ...
                $data_audit = array(
                    ...
                    'menu'    => 'Employee Record',
                    'activity' => 'Delete',
                    'description' => 'Deleted Skill table information',
                );
            } elseif ($type_id == 10) {
                // delete child data
                ...
                $data_audit = array(
                    ...
                    'menu'    => 'Employee Record',
                    'activity' => 'Delete',
                    'description' => 'Deleted Membership table information',
                );
            } elseif ($type_id == 11) {
                // delete child data
                ...
                $data_audit = array(
                    ...
                    'menu'    => 'Employee Record',
                    'activity' => 'Delete',
                    'description' => 'Deleted References table information',
                );
            } elseif ($type_id == 12) {
                // delete child data
                ...
                $data_audit = array(
                    ...
                    'menu'    => 'Employee Record',
                    'activity' => 'Delete',
                    'description' => 'Deleted Dependents table information',
                );
            } elseif ($type_id == 13) {
                // delete child data
                ...
                $data_audit = array(
                    ...
                    'menu'    => 'Employee Record',
                    'activity' => 'Delete',
                    'description' => 'Deleted Document table information',
                );
            }
