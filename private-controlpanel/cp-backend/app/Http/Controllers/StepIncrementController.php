        ...
        try {
            ...
            if ($id == 0) {
                ...
                $data_audit = array(
                    ...
                    'menu'    => 'Step Increment',
                    'activity' => 'Add',
                    'description' => 'Added employee step increment information',
                );
                ...
                $data_audit = array(
                    ...
                    'menu'    => 'Step Increment',
                    'activity' => 'Update',
                    'description' => 'Updated employee step increment information',
                );
    ...
    public function destroy($id)
    {
        try {
            ...
            $data_audit = array(
                ...
                'menu'    => 'Step Increment',
                'activity' => 'Delete',
                'description' => 'Deleted step increment information',
            );
