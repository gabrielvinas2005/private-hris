    ...
    public function up()
    {
        ...
        if ($menu_exist->isEmpty()) {
            DB::statement("
                ...
                INSERT INTO [dbo].[menus] ([id], [menu], [description], [active], [created_at], [updated_at], [menu_key], [module_id], [status]) VALUES (1, N'Employee Records', N'Contains Employee profile information', 1, NULL, NULL, N'employee_record', 1, 0)
