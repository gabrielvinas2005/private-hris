...
class SubsistenceController extends Controller
{
    ...
    public function index()
    {
        try {
            ...
            return $this->serverErrorResponse('Failed to load subsistence report data: ' . $e->getMessage());
        }
    }
    ...
    public function getReportData(Request $request)
    {
        try {
            ...
            if (!$request->department_id || !$payroll_id) {
                return $this->errorResponse('Department and payroll period are required');
            }
            ...
            END as name"),
                ...
                ->where('a.name', '=', $request->department_id) // Filter by department
