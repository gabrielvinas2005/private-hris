...
class TravelAbroadEndorsementReportController extends Controller
{
    ...
    /**
     * Get all employees for travel abroad endorsement
     */
    public function index()
    {
        try {
            ...
            return $this->successResponse($data, 'Employees for travel abroad endorsement retrieved successfully');
        } catch (\Exception $e) {
    ...
    /**
     * Get travel abroad endorsement data for specific employee
     */
    public function getEndorsementData(Request $request)
    {
        try {
            ...
            ], 'Travel abroad endorsement data retrieved successfully');
        } catch (\Exception $e) {
            return $this->serverErrorResponse('Failed to retrieve travel abroad endorsement data: ' . $e->getMessage());
        }
    }

    /**
     * Generate PDF for travel abroad endorsement (separate method for PDF generation)
     */
    public function generatePdf(Request $request)
    {
        try {
            ...
            $pdf = PDF::loadView('travel_abroad_endorsements.travel_abroad_endorsement_print', compact('employees', 'incomes', 'salary_word', 'annual_salary', 'signatories'))->setOptions(['defaultFont' => 'sans-serif']);
            $pdf->setPaper('A4');
            ...
            $filename = 'travel_abroad_endorsement_' . $request->employee . '_' . date('Y-m-d') . '.pdf';
            ...
            return $this->serverErrorResponse('Failed to generate travel abroad endorsement PDF: ' . $e->getMessage());
        }
    }

    /**
     * Show specific employee travel abroad endorsement data
     */
    public function show($id)
    {
        try {
            ...
            return $this->successResponse($data, 'Employee travel abroad endorsement data retrieved successfully');
        } catch (\Exception $e) {
