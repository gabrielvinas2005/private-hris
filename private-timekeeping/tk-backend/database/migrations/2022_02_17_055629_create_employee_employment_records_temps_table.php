...
class CreateEmployeeEmploymentRecordsTempsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('employee_employment_records_temps', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('employee_employment_records_temps');
    }
}
