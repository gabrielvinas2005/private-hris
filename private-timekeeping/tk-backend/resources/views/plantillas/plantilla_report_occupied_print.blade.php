...
<head>
    ...
    <title>Plantilla Report - Occupied Positions</title>
    <style>
        body {
...
<body>
    <div class="header">
        <div class="title">Plantilla Report - Occupied Positions</div>
    ...
    <div class="report-info">
        ...
        <strong>Total Occupied Positions:</strong> {{ $data->count() }}
    </div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: center;">{{ $position->status ?? 'Occupied' }}</td>
            </tr>
            @endforeach
        </tbody>
    </table>
