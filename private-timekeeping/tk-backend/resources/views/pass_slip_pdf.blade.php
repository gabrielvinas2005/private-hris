...
<body>
    ...
    <div class="container">
        ...
        <!-- Approval Section: signatory name from pass_slips.approved_by (employee who approved) -->
        <div class="approval-section">
            <div class="approval-text">Approved:</div>
            <div class="signature-container">
                <div class="signature-line">
                    @if($pass_slip->status === 'approved' && ($pass_slip->approved_by_name ?? $pass_slip->division_chief))
                        {{ $pass_slip->approved_by_name ?? $pass_slip->division_chief }}
                    @endif
                </div>
