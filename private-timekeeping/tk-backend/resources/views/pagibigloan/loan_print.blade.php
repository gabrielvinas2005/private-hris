...
<head>
    ...
    <title>Pag-IBIG Loan Deduction Report</title>
    <style>
        body {
...
<body>
    <div class="header">
        <div class="title">Pag-IBIG Loan Deduction Report</div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: right;">₱{{ number_format($employee->deduction_amount ?? 0, 2) }}</td>
            </tr>
            @endforeach
        </tbody>
        <tfoot>
            <tr class="total-row">
                ...
                <td style="text-align: right;"><strong>₱{{ number_format($dtl->sum('deduction_amount'), 2) }}</strong></td>
            </tr>
        </tfoot>
    </table>
