...
Route::match(['get', 'post'], '/shared-auth', 'Api\AuthController@sharedAuth');
// Authentication routes
// User authentication check route
Route::middleware('auth:sanctum')->get('/user', function (Request $request) {
    $user = $request->user();
    $userData = $user->toArray();
    $userData['is_admin'] = (bool) ($user->is_admin ?? false);
    $userData['payroll_menu_keys'] = AccessRightsController::computePayrollMenuKeys($user);
...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    // COS Payslip Routes (Contract of Service only)
    Route::get('/cos-payslips/{id}', 'COSPayslipController@index');
    Route::get('/cos-payslips/{employee_id}/view/{payroll_id}', 'COSPayslipController@view');
    ...
    Route::post('/payroll-periods/create-monthly', 'PayrollPeriodController@createMonthlyPeriods');
    Route::get('/payroll-periods/{id}/add', 'PayrollPeriodController@add');
    Route::post('/payroll-periods/{id}', 'PayrollPeriodController@store');
    Route::delete('/payroll-periods/{id}', 'PayrollPeriodController@destroy');
    Route::get('/payroll-periods/export/pdf', 'PayrollPeriodController@exportPdf');
    Route::get('/payroll-periods/export/excel', 'PayrollPeriodController@exportExcel');
    ...
    Route::delete('/payroll-item-schedules/{id}', 'PayrollItemScheduleController@destroy');
    ...
    Route::get('/payroll-income-and-deductions/{payroll_period_type_id}/{employment_type_id}/{income_id}/employee-income-merged/{secondary_payroll_period_id}', 'IncomeDeductionAjustmentController@getEmployeeIncomeMerged');
    ...
    Route::get('/loan-applications/export/pdf', 'LoanApplicationController@exportPdf');
    Route::get('/loan-applications/export/excel', 'LoanApplicationController@exportExcel');
    Route::get('/loan-applications/print', 'LoanApplicationController@print');
    ...
    Route::get('/payroll-process/{payroll_period_id}/employee/{employee_id}/breakdown', 'PayrollProcessController@getEmployeeBreakdown');
    ...
    // Per-period payroll reports
    // Basic payroll print (per employee rows)
    Route::get('/payroll-process/{id}/print-basic', 'PayrollProcessController@print');
    // Tabulated payroll print
    ...
    Route::get('/payroll-summary/print-docx', 'PayrollProcessController@payrollSummaryPrintDocx');
    Route::get('/payroll-summary/print-excel', 'PayrollProcessController@payrollSummaryPrintExcel');
    ...
    Route::get('/payroll-process/{payroll_period_id}/salary-adjustments', 'PayrollProcessController@getSalaryAdjustments');
    Route::post('/payroll-process/{payroll_period_id}/salary-adjustments', 'PayrollProcessController@saveSalaryAdjustments');
    ...
    Route::delete('/overtime-payroll/{id}', 'OvertimePayrollController@deleteOvertimePayroll');
    ...
    Route::get('/midyear-records', 'MidYearBonusController@getRecords');
    Route::patch('/midyear-records/{id}', 'MidYearBonusController@updateRecord');
    Route::delete('/midyear-records/{id}', 'MidYearBonusController@destroy');
    ...
    Route::get('/yearend-records', 'YearEndBonusController@getRecords');
    Route::patch('/yearend-records/{id}', 'YearEndBonusController@updateRecord');
    ...
    Route::post('/payroll-extra-bonus/bulk-post', 'PayrollExtraBonusController@bulkPost');
    Route::delete('/payroll-extra-bonus/{extra_bonus_id}', 'PayrollExtraBonusController@destroy');
    ...
    Route::post('/loyalty-awards/{id}/delete', 'LoyaltyAwardController@delete');
    ...
    Route::delete('/uniform-clothing/{id}', 'UniformClothingController@destroyHeader');
    ...
    Route::get('/rata-payroll/{id}/delete', 'RATAController@deleteRATAPayroll');
    ...
    Route::delete('/hazard-pay/{id}/header', 'HazardPayController@deleteHazardPayHeader');
    ...
    // Delete reimbursement header (and its details) - aligns with frontend call
    Route::get('/reimbursement/{id}/delete', 'ReimbursementCommunicationExpensesController@delete');
