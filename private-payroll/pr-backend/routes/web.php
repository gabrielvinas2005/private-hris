...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/payroll_period_delete/{id}', 'PayrollPeriodController@delete')->name('payroll_period_delete');
    Route::post('/payroll_period_process/{id}/{type_id}', 'PayrollPeriodController@process')->name('payroll_period_process');
    Route::get('/payroll_periods/print', 'PayrollPeriodController@print')->name('payroll_periods_print')->middleware('auth');
    ...
    // Delete reimbursement (align with other modules using GET)
    Route::get('/reimbursement/{id}/delete', 'ReimbursementCommunicationExpensesController@delete')->name('reimbursement_delete');
    Route::get('/reimbursement_delete/{id}', 'ReimbursementCommunicationExpensesController@delete');
