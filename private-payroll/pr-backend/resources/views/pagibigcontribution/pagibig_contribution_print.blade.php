...
<head>
    ...
    <title>Pag-IBIG Contribution Report</title>
    <style>
        body { font-family: Arial, sans-serif; margin: 0; padding: 20px; font-size: 11px; line-height: 1.3; }
        .header { text-align: center; margin-bottom: 20px; }
        .title { font-size: 14px; font-weight: bold; margin: 5px 0; text-transform: uppercase; }
        .subtitle { font-size: 12px; margin: 3px 0; }
        .company-info { text-align: center; margin-bottom: 20px; }
        .report-info { margin: 15px 0; text-align: center; }
        ...
        .signature-line { border-top: 1px solid #000; width: 100%; margin-top: 20px; }
    </style>
</head>
<body>
    <div class="header">
        <div class="title">Pag-IBIG Contribution Remittance Report</div>
