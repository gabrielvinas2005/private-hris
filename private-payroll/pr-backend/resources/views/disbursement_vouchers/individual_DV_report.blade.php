...
<head>
    ...
    <title>Disbursement Voucher - Individual</title>
        ...
        <table style="border: 2px solid #000;">
            ...
            <tr>
                ...
                <td colspan="3" style="padding: 5px; font-weight: bold; text-align: center; font-size: 11px;">
                    <p>{{ $employee->name ?? 'JUAN DELA CRUZ' }}</p>
                </td>
            ...
            <tr>
                ...
                <td colspan="5" style="padding: 5px; font-size: 11px;">
                    <p>{{ $company[0]->address ?? $orgCompanyAddress }}</p>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="3" style="padding: 8px; border-right: 2px solid #000; height: 165px;" class="text-left">
                    <p style="margin-bottom: 10px; font-size: 11px;">
                        For payment of {{ $description ?? 'Mid-year Bonus' }} for CY {{ $year ?? $bonusYear ?? date('Y') }}, as per attached supporting papers, amounting to
                    </p>
                    <div style="border: 1px solid #000; padding: 8px; margin-top: 12px;">
                        <p class="font-small font-bold" style="margin-bottom: 5px;">CERTIFICATION</p>
                        <p class="font-small" style="line-height: 1.4; margin-bottom: 18px;">
                            This is to certify that <span class="underline font-bold">{{ $employee->name ?? 'JUAN DELA CRUZ' }}</span> was not included in the payroll for CY {{ $year ?? $bonusYear ?? date('Y') }}.
                        </p>
                        <p style="margin-top: 12px; text-align: right; font-size: 11px;">
                            <span class="underline font-bold">{{ $signatories['certifying_officer_name'] ?? 'MARIA ANTONIETTE S. ZOILO' }}</span><br>
                            <span class="font-small">{{ $signatories['certifying_officer_position'] ?? 'Administrative Officer V' }}</span>
                        </p>
                    </div>
                </td>
            ...
            <tr>
                    ...
                    <table style="border: none; width: 100%; font-size: 10px; border-collapse: collapse; margin: 0;">
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="padding: 3px; border-right: 1px solid #000; border-bottom: 1px solid #000; border-left: none; border-top: none;">
                                <p class="font-bold underline" style="margin: 0;">{{ $employee->name ?? 'JUAN DELA CRUZ' }}</p>
                            </td>
                            <td style="padding: 3px; border-bottom: 1px solid #000; border-left: none; border-right: none; border-top: none;">&nbsp;</td>
                        </tr>
                        <tr>
                ...
                <td style="padding: 0; vertical-align: top;">
                    ...
                    <table style="width: 100%; border: none; font-size: 10px; border-collapse: collapse; margin: 0;">
                        <tr>
                            <td style="border-top: none; border-bottom: 1px solid #000; border-left: none; border-right: none; padding: 3px; text-align: center;">JEV No.</td>
                        </tr>
                        <tr>
                            <td style="border-bottom: 1px solid #000; border-left: none; border-right: none; border-top: none; padding: 3px; height: 20px;">&nbsp;</td>
                        </tr>
                        <tr>
                            <td style="border-bottom: none; border-left: none; border-right: none; border-top: none; padding: 3px; text-align: center;">Date</td>
                        </tr>
                        <tr>
                            <td style="padding: 3px; height: 20px; border-bottom: none; border-left: none; border-right: none; border-top: none;">&nbsp;</td>
                        </tr>
                    </table>
                </td>
            </tr>
