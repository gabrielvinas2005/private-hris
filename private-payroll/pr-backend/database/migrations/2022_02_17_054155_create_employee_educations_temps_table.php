...
class CreateEmployeeEducationsTempsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('employee_educations_temps', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('employee_educations_temps');
    }
}
