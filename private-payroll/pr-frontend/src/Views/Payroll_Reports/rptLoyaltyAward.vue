<template>
  <PageScaffold
    title="Loyalty Award"
    subtitle="Generate a loyalty award report"
    :breadcrumbs="[
      { label: 'Payroll Module', to: '/' },
      { label: 'Payroll Reports', to: '/payroll-reports' },
      { label: 'Loyalty Award Report' },
    ]"
  >
    <el-alert
      v-if="hasErrors"
    ...
    <el-card class="box-card">
      <template #header>
        <div class="card-header">
          <span>Loyalty Award Report</span>
        </div>
      </template>
...
import ReportParameters from "../../components/Payroll_Reports/rptLoyaltyAward/ReportParameters.vue";
import SignatoriesSection from "../../components/Payroll_Reports/rptLoyaltyAward/SignatoriesSection.vue";
...
const handleIntervalChange = async () => {
  // No need for interval change handling in loyalty award
  console.log("Interval change not applicable for loyalty award");
};
