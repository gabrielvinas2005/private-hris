<template>
  <PageScaffold
    title="Overtime Payment Report"
    subtitle="Generate overtime payment reports"
    :breadcrumbs="[
      { label: 'Payroll Module', to: '/' },
      { label: 'Payroll Reports', to: '/payroll-reports' },
      { label: 'Overtime Payment Report' },
    ]"
  >
    <el-alert
      v-if="hasErrors"
    ...
    <el-card class="box-card">
      <template #header>
        <div class="card-header">
          <span>Overtime Payment Report</span>
        </div>
      </template>
...
import { useOvertimePayment } from "../../Composables/useOvertimePayment.js";
import { Document, Download } from "@element-plus/icons-vue";
import ReportParameters from "../../components/Payroll_Reports/rptOvertimePayment/ReportParameters.vue";
import SignatoriesSection from "../../components/Payroll_Reports/rptOvertimePayment/SignatoriesSection.vue";
