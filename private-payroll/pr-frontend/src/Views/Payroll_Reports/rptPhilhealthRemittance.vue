<template>
  <PageScaffold
    title="PhilHealth Remittance Report"
    subtitle="Generate PhilHealth premium remittance reports"
    :breadcrumbs="[
      { label: 'Payroll Module', to: '/' },
      { label: 'Payroll Reports', to: '/payroll-reports' },
      { label: 'PhilHealth Remittance Report' },
    ]"
  >
    <el-alert
      v-if="hasErrors"
...
import ReportParameters from "../../components/Payroll_Reports/rptPhilHealthRemittance/ReportParameters.vue";
import { usePhilhealthRemittance } from "../../Composables/usePhilhealthRemittance.js";
