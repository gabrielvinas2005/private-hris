<template>
  <PageScaffold
    title="Bank Remittance Report"
    subtitle="Generate bank remittance reports for salary payments"
    :breadcrumbs="[
...
import ReportParameters from "../../components/Payroll_Reports/rptBankRemittance/ReportParameters.vue";
import { useBankRemittance } from "../../Composables/useBankRemittance.js";
