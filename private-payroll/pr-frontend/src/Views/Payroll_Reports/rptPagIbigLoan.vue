<template>
  <PageScaffold
    title="Pag-Ibig Loan Report"
    subtitle="Generate Pag-Ibig loan reports"
    :breadcrumbs="[
      { label: 'Payroll Module', to: '/' },
      { label: 'Payroll Reports', to: '/payroll-reports' },
      { label: 'Pag-Ibig Loan Report' },
    ]"
  >
    <el-alert
      v-if="hasErrors"
    ...
    <el-card class="box-card">
      <template #header>
        <div class="card-header">
          <span>Pag-Ibig Loan Information</span>
        </div>
      </template>
...
import ReportParameters from "../../components/Payroll_Reports/rptPagIbigLoan/ReportParameters.vue";
import SignatoriesSection from "../../components/Payroll_Reports/rptPagIbigLoan/SignatoriesSection.vue";
import { usePagIbigLoan } from "../../Composables/usePagIbigLoan.js";
