<template>
  <PageScaffold
    title="GSIS MEMBERSHIP INFORMATION SHEET"
    subtitle="Generate GSIS Membership Information Sheet for employees"
    :breadcrumbs="[
      { label: 'Payroll Module', to: '/' },
      { label: 'GSIS Member Info' },
    ]"
  >
    <el-alert
      v-if="hasErrors"
    ...
    <el-card class="box-card">
      <template #header>
        <div class="card-header">
          <span>GSIS Membership Information Sheet</span>
        </div>
      </template>
        ...
        >
          <template #title>
            <span style="font-size: 13px">
              The form will be automatically populated with employee information from the database.
              All fields including Personal Data and Employment Data will be filled automatically.
            </span>
          </template>
        </el-alert> -->

        <div class="card-footer">
          <h6>GSIS MEMBERSHIP INFORMATION SHEET - Form No. MIS-05-02</h6>
        </div>
      </el-form>
    </el-card>
      ...
      <el-card shadow="never">
        <div class="flex items-center justify-between mb-3">
          ...
          <div class="flex items-center gap-2">
            ...
            <el-button size="small" type="primary" @click="downloadWord">Word</el-button>
...
import { useGSISMemberInfo } from "../Composables/useGSISMemberInfo.js";
