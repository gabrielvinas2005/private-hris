        ...
        <el-col :span="12">
          <div class="form-field-section">
            <div class="field-label">
              <strong>Monetization Payroll Period:</strong>
            </div>
            <el-select
              v-model="formData.payroll_period_id"
              placeholder="Select Monetization Payroll Period"
              style="width: 100%"
              clearable
            >
              <el-option
...
const getPeriodLabel = (period) => {
  const raw = String(period?.name || "").trim();
  // Avoid showing empty parentheses like "April 2026 ()"
