      ...
      <el-row :gutter="20" class="mb-2">
        <el-col :span="24">
          <div class="form-field-section">
            ...
            <el-radio-group v-model="formData.column_display_mode">
              <el-radio label="with_values"
                >Show only attributes with values</el-radio
              >
              <el-radio label="all">Display all values even 0</el-radio>
            </el-radio-group>
          </div>
        </el-col>
      </el-row>
